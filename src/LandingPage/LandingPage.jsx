...
import { Button, Card, CardGroup, ListGroup, Container, Row, Col, Image} from 'react-bootstrap';
      ...
      <Row>
        <Col>
          <Card
            ...
            <Card.Text>
            <p>Master Skeletor has ruled over this decrepit place for 1,000 years and
            ...
            prisoners free, but none have succeeded.</p>

            <p>However, our hero Boris Bones is tired of the dampness of this cave.
      ...
      <Row className="justify-content-around">
        <Col>
          <Card className="text-center" style={{ width: '11rem' }}>
            ...
            <Card.Body>
              <Card.Title style={{ backgroundColor: 'gray',  }}>Bermet Tariel</Card.Title>
        ...
        <Col>
          <Card className="text-center" style={{ width: '11rem' }}>
            ...
            <Card.Body >
              <Card.Title style={{ backgroundColor: 'gray' }}>Vada Karlen</Card.Title>
        ...
        <Col>
          <Card className="text-center" style={{ width: '11rem' }}>
            ...
            <Card.Body >
              <Card.Title style={{ backgroundColor: 'gray' }}>Grant Nichols</Card.Title>
