      ...
      <div id="footer">
        ...
        <Offcanvas show={show} onHide={handleClose} placement="end">
          <Offcanvas.Header closeButton>
            <Offcanvas.Title>The Developers</Offcanvas.Title>
          </Offcanvas.Header>
            ...
            <Container>
              ...
              <Row className="justify-content-around mb-3">
                ...
                <Col xs={6} className="text-center m-auto">
                  <p style={{ backgroundColor: '#7db1b3' }}>Bermet Tariel</p>
              ...
              <Row className="justify-content-around mb-3">
                ...
                <Col xs={6} className="text-center m-auto">
                  <p style={{ backgroundColor: '#7db1b3' }}>Vada Karlen</p>
              ...
              <Row className="justify-content-around mb-3">
                ...
                <Col xs={6} className="text-center m-auto">
                  <p style={{ backgroundColor: '#7db1b3' }}>Grant Nichols</p>
